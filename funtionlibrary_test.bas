...
call test "upto$()"
call assert #lib upto$("Hello world!", "apple"), ""
call assert #lib upto$("Hello world!", "H"), ""
call assert #lib upto$("Hello world!", "llo"), "He"
call assert #lib upto$("Hello World!", "!"), "Hello World"
...
call test "after$()"
call assert #lib after$("Hello world!", "apple"), ""
call assert #lib after$("Hello World!", "H"), "ello World!"
call assert #lib after$("Hello world!", "llo"), " world!"
call assert #lib after$("Hello World!", "!"), ""

call test "afterLast$()"
call assert #lib afterLast$("Hello world!", "apple"), ""
call assert #lib afterLast$("Hello World!", "H"), "ello World!"
call assert #lib afterLast$("Hello world!", "o"), "rld!"
call assert #lib afterLast$("Hello World!", "!"), ""
call assert #lib afterLast$("Hello Bob, Hello World!", "Hello"), " World!"
...
call test "endsWith()"
call assertn #lib endsWith("Hello World!", "world"), 0
call assertn #lib endsWith("Hello World!", "World!"), 1
call assertn #lib endsWith("Hello World!", ""), 1
...
call test "startsWith()"
call assertn #lib startsWith("Hello World!", "ello"), 0
call assertn #lib startsWith("Hello World!", "Hello"), 1
call assertn #lib startsWith("Hello World!", ""), 1
...
sub assert in$, expected$
  ...
  if in$ <> expected$ then
    ...
    html " <span style=""color: red; font-weight: bold;"">FAILED</span>"
  else
    testok = testok + 1
